      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {plans.map((plan) => (
          ...
          >
            ...
            <button className='mt-6 bg-purple-600 hover:bg-purple-700 active:bg-putple-800 text-white font-medium py-2 rounded transition-colors cursor-pointer'>Buy Now</button>
          </div>
        ))}
      </div>
    </div>
