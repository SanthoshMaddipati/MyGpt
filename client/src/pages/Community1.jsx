  ...
  return (
    <div className='p-6 pt-12 xl:px-12 2xl:px-20 w-full mx-auto h-full overflow-y-scroll'>
      ...
      {images.length > 0 ? (
          ...
          {images.map((item, index) => (
            ...
            >
              <img
                src={item.imageUrl}
                alt=''
                className='w-60 h-40 md:h-50 2xl:h-64 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out'
              />
        ...
        <p className='text-center text-gray-600 dark:text-purple-200 mt-10'>No images Avilable.</p>
      )}
